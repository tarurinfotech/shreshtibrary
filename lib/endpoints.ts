...
export const endpoints = {
  ...
  downloadBackup: (id: string) => downloadFile(`/superadmin/backup/${id}/download`, `backup-${id}.json`),
  ...
  updatePlatformPlan: (id: number, payload: any) => putData<any>(`/licensing/platform-plans/${id}`, payload),
  deletePlatformPlan: (id: number) => deleteData<any>(`/licensing/platform-plans/${id}`),
  togglePlatformPlan: (id: number, isActive?: boolean) => patchData<any>(`/licensing/platform-plans/${id}/toggle`, { isActive }),
  ...
  rejectLibraryPayment: (id: number) => postData<any>(`/licensing/library-payments/${id}/reject`),
